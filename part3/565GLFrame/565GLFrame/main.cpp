...
void initPass() {
	...
	shaders = Utility::loadShaders("Morph.vert", "pass.frag");
	...
	shaders = Utility::loadShaders("Bulge.vert", "pass.frag");
...
void draw_quad() {
	...
	//glUniform1f(glGetUniformLocation(ssao_prog,"u_time"), time1);
...
void keyboard(unsigned char key, int x, int y) {
	...
	case('0'):
	  ...
	  break;
	case('m'):
		current_prog = morph_prog;		
		break;
	case('b'):
		current_prog = pulse_prog;	
		break;
	case('p'):
		current_prog = pass_prog;	
		break;
